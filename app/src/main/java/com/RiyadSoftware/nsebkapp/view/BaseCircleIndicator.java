package com.RiyadSoftware.nsebkapp.view;
...
class BaseCircleIndicator extends LinearLayout {
    ...
    private Config handleTypedArray(Context context, AttributeSet attrs) {
        ...
        config.backgroundResId = typedArray.getResourceId(R.styleable.BaseCircleIndicator_ci_drawable, R.drawable.orange_rect);
        config.unselectedBackgroundId = typedArray.getResourceId(R.styleable.BaseCircleIndicator_ci_drawable_unselected,
    ...
    public void initialize(Config config) {
        ...
        mIndicatorBackgroundResId =
                (config.backgroundResId == 0) ? R.drawable.orange_rect : config.backgroundResId;
        mIndicatorUnselectedBackgroundResId =
                (config.unselectedBackgroundId == 0) ? R.drawable.orange_rect
    ...
    public  void internalPageSelected(int position) {
